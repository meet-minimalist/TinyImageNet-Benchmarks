# -*- coding: utf-8 -*-
"""
Created on Sat Jan 19 20:16:01 2020
...
import models.ResNet34_config as ResNet34_config
from models.ResNet34_config import g
...
class ResNet34:
    def __init__(self, input_dims=(64, 64), num_classes=200):
        ...
        self.k_reg = tf.contrib.layers.l2_regularizer(scale=ResNet34_config.weight_decay)
