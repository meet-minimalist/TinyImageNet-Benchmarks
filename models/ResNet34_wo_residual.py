...
import models.ResNet34_wo_residual_config as ResNet34_wo_res_config
from models.ResNet34_wo_residual_config import g

class ResNet34_wo_res:
    def __init__(self, input_dims=(64, 64), num_classes=200):
        self.model_name = 'ResNet34_wo_residual'
        self.num_classes = num_classes
        self.k_init = tf.contrib.layers.xavier_initializer()
        self.k_reg = tf.contrib.layers.l2_regularizer(scale=ResNet34_wo_res_config.weight_decay)
