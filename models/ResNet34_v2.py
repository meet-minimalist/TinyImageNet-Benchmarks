# -*- coding: utf-8 -*-
"""
Created on Sat Jan 19 20:24:01 2020
...
import models.ResNet34_v2_config as ResNet34_v2_config
from models.ResNet34_v2_config import g

class ResNet34_v2:
    def __init__(self, input_dims=(64, 64), num_classes=200):
        self.model_name = 'ResNet34_v2'
        self.num_classes = num_classes
        self.k_init = tf.contrib.layers.variance_scaling_initializer()  # as per paper
        self.k_reg = tf.contrib.layers.l2_regularizer(scale=ResNet34_v2_config.weight_decay)
