...
import models.ResNet18_config as ResNet18_config
from models.ResNet18_config import g
...
class ResNet18:
    def __init__(self, input_dims=(64, 64), num_classes=200):
        ...
        self.k_reg = tf.contrib.layers.l2_regularizer(scale=ResNet18_config.weight_decay)
